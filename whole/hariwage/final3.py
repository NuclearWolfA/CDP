...
class final3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500, puncpat='11'):
        ...
        self.file_name = file_name = './text.txt'
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/tharoosha/CDP/whole/hariwage/text.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, './output.txt', False)

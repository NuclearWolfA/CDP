...
class mpsk_stage2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._time_offset_win = RangeWidget(self._time_offset_range, self.set_time_offset, "Channel: Timing Offset", "counter", float, QtCore.Qt.Horizontal)
        ...
        self._noise_volt_win = RangeWidget(self._noise_volt_range, self.set_noise_volt, "Channel: Noise Voltage", "counter", float, QtCore.Qt.Horizontal)
        ...
        self._freq_offset_win = RangeWidget(self._freq_offset_range, self.set_freq_offset, "Channel: Frequency Offset", "counter", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_const_sink_x_0, 1))

...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.hdr_format_0 = hdr_format_0 = digital.header_format_crc(len_key, num_key)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/tharoosha/CDP/project testing/packet transmiting/padded.txt', True, 0, 0)
        ...
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.digital_constellation_modulator_0, 0))
    ...
    def set_num_key(self, num_key):
        ...
        self.set_hdr_format_0(digital.header_format_crc(self.len_key, self.num_key))

...
import image_epy_block_0_0 as epy_block_0_0  # embedded python block
...
class image(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500, puncpat='11'):
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_char, 1, 'tcp://127.0.0.1:49204', 100, False, -1, '')
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:49202', 100, True, -1, '')
        ...
        self.epy_block_0_0 = epy_block_0_0.blk(FileName=file_name, Pkt_len=20)
        ...
        self.connect((self.zeromq_sub_source_0, 0), (self.digital_map_bb_0, 0))

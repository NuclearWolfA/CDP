...
import mpsk_stage6_epy_block_0_0 as epy_block_0_0  # embedded python block
...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts/2, nfilts/2, 1.0/float(sps), 3, 11*sps*nfilts)
        self.phase_bw = phase_bw = 6.28/100.0
        self.noise_volt = noise_volt = 0.0001
        self.hdr_format = hdr_format = digital.header_format_default(access_key, 0)
        self.freq_offset = freq_offset = 0
        self.file_name = file_name = '/home/tharoosha/gr-control/gr-logo.png'
        self.excess_bw = excess_bw = 0.35
        self.eq_gain = eq_gain = 0.01
        self.delay = delay = 50
        self.arity = arity = 128
        ...
        self.soapy_bladerf_source_0.set_sample_rate(0, 600e3)
        self.soapy_bladerf_source_0.set_bandwidth(0, 0.0)
        self.soapy_bladerf_source_0.set_frequency(0, 2.6e9)
        ...
        self.soapy_bladerf_sink_0 = soapy.sink(dev, "fc32", 1, '',
                                  stream_args, tune_args, settings)
        self.soapy_bladerf_sink_0.set_sample_rate(0, 600e3)
        self.soapy_bladerf_sink_0.set_bandwidth(0, 0.0)
        self.soapy_bladerf_sink_0.set_frequency(0, 2.6e9)
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(5, 2, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(self.nfilts/2, self.nfilts/2, 1.0/float(self.sps), 3, 11*self.sps*self.nfilts))

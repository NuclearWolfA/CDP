...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts/2,nfilts/2, 1.0/float(sps), 2.0, 11*sps*nfilts)
        ...
        self.soapy_bladerf_source_0.set_sample_rate(0, 600000)
        self.soapy_bladerf_source_0.set_bandwidth(0, 500000)
        self.soapy_bladerf_source_0.set_frequency(0, 433*10**6)
        ...
        self.soapy_bladerf_sink_0 = soapy.sink(dev, "fc32", 1, '',
                                  stream_args, tune_args, settings)
        self.soapy_bladerf_sink_0.set_sample_rate(0, 600000)
        self.soapy_bladerf_sink_0.set_bandwidth(0, 500000)
        self.soapy_bladerf_sink_0.set_frequency(0, 433*10**6)
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(20, 2, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(self.nfilts/2,self.nfilts/2, 1.0/float(self.sps), 2.0, 11*self.sps*self.nfilts))

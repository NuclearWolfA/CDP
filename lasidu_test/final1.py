...
import final1_epy_block_0_0 as epy_block_0_0  # embedded python block



from gnuradio import qtgui

class final1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "final1")
        ...
        self.file_name = file_name = "./input.txt"
...
def main(top_block_cls=final1, options=None):
